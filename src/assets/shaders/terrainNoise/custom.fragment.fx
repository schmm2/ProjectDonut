...
float fbm3d(vec3 x, const in int octaves) {
  float value = 0.0;
  float amplitude = 1.0;
  ...
  for (int i = 0; i < octaves; ++i) {
    ...
    x *= lacunarity;
    // fbm applies smaller and smaller noise to each octave
    amplitude *= gain;
  }
  return value;
}
...
void main(void) {
  ...
  // the heightmap is manipulated by a gradient image.
  // the land close the the edges should be more flat, at the center heigher
  // this results in a more island shaped terrain
