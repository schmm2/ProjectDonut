...
void main(void){
    ...
    vec4 waveA = vec4(1.0,1.,0.1,10.0);
    vec4 waveB = vec4(1.0,0.6,0.1,8.);
    vec4 waveC = vec4(0.8,1.3,0.1,10.);
    vec4 waveD = vec4(1.0,.5,0.1,6.0);
    vec4 waveE = vec4(0.5,0.6,0.1,10.0);
    vec4 waveF = vec4(0.5,0.4,0.1,6.0);
