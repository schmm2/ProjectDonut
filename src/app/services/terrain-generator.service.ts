...
export class TerrainGeneratorService {
  ...
  public buildTerrain() {
    ...
    const islandA2Mesh = Mesh.CreateGroundFromHeightMap('island', islandCUrl, 250, 250, 250, 0, 20, this.scene, false, TerrainGeneratorService.successCallback);

    // create materials
    // Create the mix material
    const mix = new BABYLON.MixMaterial('terrainMix', this.scene);
    mix.mixTexture1 = new Texture('assets/textures/terrain/islandCMixMap.png', this.scene);

    // diffuse textures
    mix.diffuseTexture1 = new Texture('assets/textures/material/grass.jpg', this.scene); // R
    mix.diffuseTexture2 = new Texture('assets/textures/material/sandy_rocks1_albedo.png', this.scene); // G
    mix.diffuseTexture3 = new Texture('assets/textures/material/sand2.jpg', this.scene); // B
    mix.diffuseTexture4 = new Texture('assets/textures/material/ground.jpg', this.scene); // A
